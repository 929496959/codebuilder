C:\Windows\Microsoft.NET\Framework\v4.0.30319\MSBuild.exe CodeBuilder.sln /t:Rebuild /t:Clean /p:Configuration=Release;TargetFrameworkVersion=v4.0;Platform=x64 /clp:ErrorsOnly
C:\Windows\Microsoft.NET\Framework\v4.0.30319\MSBuild.exe CodeBuilder.sln /t:Rebuild /t:Clean /p:Configuration=Release;TargetFrameworkVersion=v4.0;Platform=x86 /clp:ErrorsOnly
